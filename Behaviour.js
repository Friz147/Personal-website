...
───────────────────────────────────────────────────────── */
const projectData = {
  'art-for-all':     { title: 'Art For All',      tag: 'Erasmus+',        desc: 'An inclusive approach to art, bridging accessibility and creativity through an Erasmus+ partnership. The project explores how design can lower barriers to cultural participation for people of all abilities.',                                                                        img: 'images/artforall.png',      index: '01 / 06' },
  ...
  'micro-instrument':{ title: 'Micro-instrument',  tag: 'Microbit',        desc: 'A Microbit-based project that translates body movement into sound — turning the user into a living instrument. Explores the intersection of physical computing, education, and musical expression.',                                                                                img: 'images/micro c.jpeg',       index: '06 / 06' },
};
